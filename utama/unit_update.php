...
<!-- Page Container START -->
    ...
    <div class="container-fluid">
        <div class="page-title">
            <h4>Form Update Data Unit Kerja</h4>
        </div>
                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <?php
                            ...
                            $cek = mysqli_query($connect,"SELECT * from unit_kerja where unit_id='$unit_id'");
                            while($unit = mysqli_fetch_array($cek)){
                        ?>

                        <form class="form-horizontal mrg-top-40 pdd-right-30" action="proses/unit_update.php" method="POST">
                        
                        <div class="form-group row">
                            <label for="form-1-1" class="col-md-2 control-label">ID Unit Kerja</label>
                            <div class="col-md-10">
                            <input type="text" class="form-control" name="unit_id" value="<?php echo $unit['unit_id']; ?>" readonly onKeyPress="if(this.value.length==30) return false;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <select name="skpd_id" class="form-control" value="<?php echo $unit['skpd_id']; ?>">
                            <option disabled="">-Pilih ID SKPD-</option>
                            <?php
                                $unit_skpd = $unit['skpd_id'];
                        ...
                        <div class="form-group row">
                            <label for="form-1-3" class="col-md-2 control-label">Nama Unit Kerja</label>
                            <div class="col-md-10">
                            <input type="text" class="form-control" name="unit_nama"  required 
                            value="<?php echo $unit['unit_nama']; ?>" onKeyPress="if(this.value.length==50) return false;">
                            </div>
                        </div>
