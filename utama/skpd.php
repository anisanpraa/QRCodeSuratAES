            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-block">
                       	<a href="skpd_tambah.php" class="btn btn-info">
                           ...
                           <table id="tabel" class="table table-lg table-hover">
                              <thead class="thead-light">
                               ...
                               <tbody>
                                <?php
        							$no = 1;
        							$sql = mysqli_query($connect,"SELECT * FROM skpd");
        								while($skpd = mysqli_fetch_array($sql)){
      							?>
      							...
      							<tr>
                                    ...
                                    <td><div class="mrg-top-18">
                                        <span class="text-dark"><?php echo $skpd['skpd_id']; ?></span>
                                    </div></td>                                        

                                    <td><div class="mrg-top-18">
                                        <span class="text-dark"><?php echo $skpd['skpd_nama']; ?></span>
                                    </div></td>

                                    <td><div class="mrg-top-18">
                                        <span class="text-dark"><?php echo $skpd['skpd_tlp']; ?></span>
                                    </div></td>

                                    <td><div class="mrg-top-18">
                                        <span class="text-dark"><?php echo $skpd['skpd_email']; ?></span>
                                    </div></td>

                                    <td><div class="mrg-top-18">
                                        <span class="text-dark"><?php echo $skpd['skpd_alamat']; ?></span>
                                    </div></td>

                                    <td><div class="mrg-top-18">
                                        <span class="text-dark"><?php echo $skpd['skpd_pimpinan']; ?></span>
                                    </div></td>
                                    ...
                                    <td><div class="mrg-top-18">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="skpd_update.php?skpd_id=<?php echo $skpd['skpd_id']; ?>" class="text-dark">
                                                <i class="fas fa-edit"></i>
                                                <span>Edit</span></a></li>
                                                
                                            <li><a href="proses/skpd_hapus.php?skpd_id=<?php echo $skpd['skpd_id']; ?>" class="text-dark" id="btn-del">
