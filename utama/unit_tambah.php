...
<!-- Page Container START -->
    ...
    <div class="container-fluid">
        <div class="page-title">
            <h4>Form Tambah Data Unit Kerja</h4>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-block">
                        ...
                        <form class="form-horizontal mrg-top-40 pdd-right-30" name="unitadd" action="proses/unit_add.php" method="POST">
                        
                        <div class="form-group row">
                            <label for="form-1-1" class="col-md-2 control-label">ID Unit Kerja</label>
                            <div class="col-md-10">
                            <input type="text" class="form-control" name="unit_id" placeholder="ID Unit Kerja" required onKeyPress="if(this.value.length==30) return false;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                            <input type="text" class="form-control" name="unit_nama" placeholder="Nama Unit Kerja" required onKeyPress="if(this.value.length==50) return false;">
                            </div>
                        </div>
