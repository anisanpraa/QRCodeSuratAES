            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-block">
                       	<a href="unit_tambah.php" class="btn btn-info">
                                ...
                                <?php
      							...
      							<tr>
                                    ...
                                    <td><div class="mrg-top-18">
                                        <span class="text-dark"><?php echo $unit['unit_id']; ?></span>
                                    </div></td>                                        

                                    <td><div class="mrg-top-18">
                                        <span class="text-dark"><?php echo $unit['skpd_nama']; ?></span>
                                    </div></td> 

                                    <td><div class="mrg-top-18">
                                        <span class="text-dark"><?php echo $unit['unit_nama']; ?></span>
                                    </div></td>                             
                                    ...
                                    <td><div class="mrg-top-18">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="unit_update.php?unit_id=<?php echo $unit['unit_id']; ?>" class="text-dark">
                                                <i class="fas fa-edit"></i>
                                                <span>Edit</span></a></li>
                                                
                                            <li><a href="proses/unit_hapus.php?unit_id=<?php echo $unit['unit_id']; ?>" class="text-dark" id="btn-del">
